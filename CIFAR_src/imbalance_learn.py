...
directory_generate_data = '../data/cifar/data_50/' #'../data/cifar/data_50/label_0/' #
...
with tf.device('/gpu:1'):
    ...
    if CLASSIFY_TYPE == 'MLP':
        ...
        model = Sequential()
        model.add(Dense(126, activation='relu', input_shape=(3072,)))
        ...
        image_shape_for_train = (-1, 32, 32, 3)  #   
